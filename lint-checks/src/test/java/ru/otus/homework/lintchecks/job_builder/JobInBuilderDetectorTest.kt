...
import ru.otus.homework.lintchecks.androidxLifecycle
import ru.otus.homework.lintchecks.kotlinCoroutines
import ru.otus.homework.lintchecks.kotlinxCoroutines

@Suppress("UnstableApiUsage")
internal class JobInBuilderDetectorTest {

    private val lintTask = lint().allowMissingSdk().issues(JobInBuilderIssue.ISSUE)
